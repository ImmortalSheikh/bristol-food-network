...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-fqs_de1kcvp(_vxht$ql_p11arg*$xu_y6ku+9x@du2sp=3_e@')
...
if os.environ.get('POSTGRES_HOST'):
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('POSTGRES_DB', 'bristol_food_network'),
